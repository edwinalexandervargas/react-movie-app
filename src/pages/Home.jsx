...
const Home = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-blue-300 to-slate-200 h-screen flex flex-col items-center justify-center">
      ...
      <button onClick={() => navigate('/search')} className="bg-blue-700 text-white hover:bg-blue-800 px-6 py-4 mb-10 text-xl font-semibold rounded-full transition-all duration-300 cursor-pointer">
        Browse Films
      </button>
